...
namespace HarmonyLibTests.Assets
{
	public class TraverseProperties
	{
		...
		{
			"PublicProperty", "PublicPrivateProperty", "AutoProperty", "BaseProperty1", "BaseProperty2",
			"BaseProperty3", "ImmediateProperty"
		};
	}

	public class TraverseProperties_BaseClass
	{
		private string _basePropertyField1;
		...
		private string _basePropertyField2;
	...
	public class TraverseProperties_AccessModifiers : TraverseProperties_BaseClass
	{
		...
		private string _basePropertyField3;
		...
		private string ImmediateProperty => TraverseProperties.testStrings.Last();
